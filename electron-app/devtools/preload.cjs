...
contextBridge.exposeInMainWorld("variantDevtools", {
  ...
  buildReselectRuntimeFramesPreview: (payload) => ipcRenderer.invoke("devtools:buildReselectRuntimeFramesPreview", payload),
  reselectRuntimeFrames: (previewId) => ipcRenderer.invoke("devtools:reselectRuntimeFrames", previewId),
  buildDeleteActionPreview: (payload) => ipcRenderer.invoke("devtools:buildDeleteActionPreview", payload),
  deleteAction: (previewId) => ipcRenderer.invoke("devtools:deleteAction", previewId),
