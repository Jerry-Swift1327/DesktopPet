...
const WINDOW_SURFACE_STABILITY_TOLERANCE_PX = 1;
...
const PET_CLICK_HOVER_SUPPRESS_MS = HOVER_HIDE_DELAY_MS;
...
const WINDOW_DOCK_DRAG_HOVER_SUPPRESS_MS = 1250;

// 窗口漫游
const WINDOW_ROAM_POLL_INTERVAL_MS = 450;
const WINDOW_ROAM_MAX_MISSING_TICKS = 2;
const WINDOW_ROAM_START_ATTACH_DELAY_MS = 650;
const WINDOW_ROAM_INVALID_FALLBACK_SUPPRESS_MS = 700;
...
const RAGDOLL_YAWN_SLEEP_LOOP_MAX_MS = 5 * 60 * 1000;
