...
| 文件 | 覆盖内容 | 相关源码 |
| --- | --- | --- |
| `walk-controller-window-frame.test.cjs` | Window surface walk regression: use the current rendered frame geometry for grounding and horizontal clamping. | `../electron/behavior/walk-controller.cjs` |
