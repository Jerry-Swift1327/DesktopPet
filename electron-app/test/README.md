...
| 文件 | 覆盖内容 | 相关源码 |
| --- | --- | --- |
| `walk-controller-window-frame.test.cjs` | Window surface walk regression: stable visible-center track drives the real pet window, and frameStep does not change walk speed. | `../electron/behavior/walk-controller.cjs` |
